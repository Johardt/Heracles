...
public final class ResourcefulConfigBridge {
    ...
    private static final String INTEGRATION_CLASS =
        "me.johardt.heracles.client.resourceful.ResourcefulClientOptions";
    ...
    public static void registerIfAvailable() {
        ...
        try {
            ...
            saveMethod = integration.getMethod(
                "saveFromPreferences",
                HeraclesClientOptions.Preferences.class
            );
            LOGGER.info("Resourceful Config support enabled for Heracles client options");
        } catch (ReflectiveOperationException | LinkageError exception) {
            LOGGER.warning("Resourceful Config was detected but could not be integrated: " + exception);
        }
    }

    public static boolean save(HeraclesClientOptions.Preferences preferences) {
        ...
        try {
            ...
            LOGGER.warning("Could not synchronize Heracles options with Resourceful Config: " + exception);
            saveMethod = null;
            return false;
        }
    }
