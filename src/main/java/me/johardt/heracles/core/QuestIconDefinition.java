...
public final class QuestIconDefinition {
    public static final String ITEM_TYPE = "heracles:item";
    ...
    public static QuestIconDefinition parse(JsonElement source, String fallbackItem) {
        ...
        if (!source.isJsonObject()) {
            return new QuestIconDefinition(source, "heracles:unknown", fallback, true);
        }
        JsonObject object = source.getAsJsonObject();
        String type = primitiveString(object.get("type"), object.has("item") ? ITEM_TYPE : "heracles:unknown");
