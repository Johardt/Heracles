...
public final class QuestTutorialScreen extends Screen {
    ...
    public QuestTutorialScreen(Screen parent) {
        super(Component.translatable("screen.heracles.quest_tutorial"));
        this.parent = parent;
        ...
        addRenderableWidget(Widgets.button(widget -> {
            ...
            widget.withRenderer(WidgetRenderers.text(Component.translatable(
                HeraclesClientOptions.tutorialAutoShow()
                    ? "screen.heracles.tutorial.auto_show_on"
                    : "screen.heracles.tutorial.auto_show_off"
            )));
            widget.withCallback(() -> {
                HeraclesClientOptions.setTutorialAutoShow(!HeraclesClientOptions.tutorialAutoShow());
                rebuildWidgets();
            });
            widget.withTooltip(Component.translatable("screen.heracles.tutorial.auto_show.tooltip"));
        }));
