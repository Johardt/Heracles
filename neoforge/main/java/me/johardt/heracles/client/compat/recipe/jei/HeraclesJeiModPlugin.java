package me.johardt.heracles.client.compat.recipe.jei;
...
@JeiPlugin
public final class HeraclesJeiModPlugin implements IModPlugin {
    private static final Identifier ID = Identifier.fromNamespaceAndPath(Heracles.MOD_ID, "jei");
    private final Adapter adapter = new Adapter();

    public HeraclesJeiModPlugin() {
